                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(obj,function(index,value){
                            ...
                            table_content+="<td contenteditable=\"true\"><center>"+value.time+"</center></td>";
                        });
...
$query=mysql_query("select count(*) from finalList");
    ...
    <div class="panel panel-right panel-reveal">
      <div class="user_login_info">        
        ...
        <div id="pages_maincontent">
          ...
          <h2 class="page_title">Final List</h2>
          
              <div class="page_single layout_fullwidth_padding">
                   
                    <div class="videocontainer"><center><strong style="text-align: right;">COUNT : <?php echo ($row[0]); ?></strong></center>
